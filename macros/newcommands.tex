...
% Definieren der Befehle \secref \tabref und \figref um nicht immer Kapitel, Tabelle und Abbildung schreiben zu müssen
...
\newcommand{\lemmaref}[1]{Lemma~\ref{#1}}
\newcommand{\satzref}[1]{Sentence~\ref{#1}} 

% Abkürzung zum Hochstellen und Tiefstellen von Text
\newcommand{\up}{\textsuperscript}
\newcommand{\down}{\textsubscript}  %%textsubscript ist in den KOMA Klassen bereits eingebunden ansonsten muss nachtraeglich das subscript Paket eingebunden werden