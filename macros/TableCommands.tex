...
\IfPackageLoaded{xcolor}{
	\colorlet{tablecaptioncolor}{white!} 
...
\newcommand\tablestylecommon{%
  ...
  \normalfont\normalsize            %
  \rmfamily\tablefontsize           % Serifenlose und kleine Schrift
...
\newcommand\tablecaptioncolor{%
	%\rowcolor{tablesubheadcolor}
	%\rowcolor{tableblackheadcolor}
	\rowcolor{tablecaptioncolor}%
}
